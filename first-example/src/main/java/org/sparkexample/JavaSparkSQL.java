...
/**
 * Created by hottelet on 1/31/16.
 */
/*
...
public class JavaSparkSQL {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkConf sparkConf = new SparkConf().setAppName("org.sparkexample.JavaSparkSQL").setMaster("local");
        JavaSparkContext ctx = new JavaSparkContext(sparkConf);
        SQLContext sqlContext = new SQLContext(ctx);

        System.out.println("=== Data source: RDD ===");
        // Load a text file and convert each line to a Java Bean.
        JavaRDD<Person> people = ctx.textFile("/Users/hottelet/Desktop/spark-examples-master/first-example/src/test/resources/people.txt").map(
        ...
        String path = "/Users/hottelet/Desktop/spark-examples-master/first-example/src/test/resources/people.json";
